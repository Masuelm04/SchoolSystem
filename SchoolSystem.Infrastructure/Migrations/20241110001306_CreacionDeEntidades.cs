    ...
    public partial class CreacionDeEntidades : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CursosMaterias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CursosMaterias_Cursos_IdCurso",
                        column: x => x.IdCurso,
                        principalTable: "Cursos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CursosMaterias_Materias_IdMateria",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdEstadoAsistencia = table.Column<int>(type: "int", nullable: false),
                    FechaRegistro = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Eliminado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Asistencias_EstadosAsistencia_IdEstadoAsistencia",
                        column: x => x.IdEstadoAsistencia,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Asistencias_IdEstadoAsistencia",
                table: "Asistencias",
                column: "IdEstadoAsistencia");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CursosMaterias_IdCurso",
                table: "CursosMaterias",
                column: "IdCurso");

            migrationBuilder.CreateIndex(
                name: "IX_CursosMaterias_IdMateria",
                table: "CursosMaterias",
                column: "IdMateria");
